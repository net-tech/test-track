...
const checkWatchedUsers_1 = require("./jobs/checkWatchedUsers");
...
boot_1.default.init();
const fileEnd = boot_1.default.environment() === "development" ? ".ts" : ".js";
/* Command Handling */
...
/* Cron Jobs */
new croner_1.default("0 * * * *", async () => {
    try {
        (0, checkWatchedUsers_1.checkWatchedUsers)(exports.client);
        logger_1.log.info("Checked watched users");
    }
    catch (error) {
        logger_1.log.error(error, "Failed to check watched users");
    }
});
